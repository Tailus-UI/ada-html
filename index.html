                ...
                <div class="mx-auto px-6 max-w-6xl">
                    <div class="relative">
                        <div class="relative z-10 grid gap-3 grid-cols-6">
                            <div class="card variant-outlined col-span-full lg:col-span-2 overflow-hidden flex relative">
                                <div class=" size-fit m-auto relative">
                                    <div class="relative h-24 w-56 flex items-center">
                                        ...
                                        <span class="w-fit block mx-auto text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-primary-300 to-primary-700 dark:from-primary-400 dark:to-primary-700">100%</span>
                                    </div>
                                    <h2 class="mt-6 text-center font-semibold text-3xl text-title">Customizable</h2>
                                </div>
                            </div>
                            <div class="card variant-outlined col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative ">
                                <div>
                                    ...
                                    <div class="mt-6 text-center relative z-10 space-y-2">
                                        ...
                                        <p class="">Provident fugit and vero voluptate. magnam magni doloribus dolores voluptates a sapiente nisi.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card variant-outlined col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative ">
                                <div>
                                        ...
                                        <svg class="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                    <stop class="text-primary-300/20 dark:text-primary-600/30" stop-color="currentColor"/>
                                                    <stop class="text-transparent" offset="1" stop-color="currentColor" stop-opacity="0.103775"/>
                                                </linearGradient>
                                    ...
                                    <div class="mt-14 text-center relative z-10 space-y-2">
                                        <h2 class="text-lg font-medium transition group-hover:text-secondary-950">Faster than light</h2>
                                        <p class="">Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card variant-outlined col-span-full lg:col-span-3 overflow-hidden relative ">
                                <div class="grid sm:grid-cols-2">
                                    ...
                                    <div data-rounded="large" class="relative mt-6 sm:mt-auto h-fit -mb-[calc(var(--card-padding)+1px)] -mr-[calc(var(--card-padding)+1px)] sm:ml-6 py-6 p-6 card variant-soft ">
                                ...
                                <div class="h-full grid sm:grid-cols-2">
                                    <div class="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="">Voluptate. magnam magni doloribus dolores voluptates a sapiente inventore nisi.</p>
                                        </div>
                                    </div>
                                    <div class="mt-6 relative sm:-mr-[--card-padding] sm:-my-[--card-padding] before:absolute before:w-px before:inset-0 before:mx-auto before:bg-[--ui-border-color]">
                                        <div class="relative space-y-6 py-6 flex flex-col justify-center h-full">
                                            <div class="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative">
                                                <span class="h-fit text-xs block px-2 py-1 shadow-sm card variant-mixed">Likeur</span>
                                                <div class="size-7 ring-4 ring-[--ui-bg]">
                                                    <img class="rounded-full size-full" src="https://avatars.githubusercontent.com/u/102558960?v=4" alt="">
                                                </div>
                                            </div>
                                            <div class="flex items-center gap-2 ml-[calc(50%-1rem)] relative">
                                                <div class="size-8 ring-4 ring-[--ui-bg]">
                                                    <img class="rounded-full size-full" src="https://avatars.githubusercontent.com/u/47919550?v=4" alt="">
                                                </div>
                                                <span class="h-fit text-xs block px-2 py-1 shadow-sm card variant-mixed">M. Irung</span>
                                            </div>
                                            <div class="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative">
                                                <span class="h-fit text-xs block px-2 py-1 shadow-sm card variant-mixed">B. Ng</span>
                                                <div class="size-7 ring-4 ring-[--ui-bg]">
                                                    <img class="rounded-full size-full" src="https://avatars.githubusercontent.com/u/31113941?v=4" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="mx-auto px-6 max-w-6xl">
                    ...
                    <div class="mt-12 relative w-fit h-fit sm:mx-auto sm:px-0 -mx-6 px-6 overflow-x-auto">
                        <div class="mb-3 flex w-fit mx-auto gap-3">
                            <div class="card variant-mixed bg-ui flex relative *:relative *:size-7 *:m-auto size-20 mx-auto ">
            ...
            <div class="pt-36">
                <div class="mx-auto px-6 max-w-6xl">
                    <div class="grid gap-12 md:gap-0 md:grid-cols-2 lg:grid-cols-5 items-center lg:gap-24">
                        ...
                        <div class="overflow-hidden lg:col-span-3 p-3 card variant-outlined">
